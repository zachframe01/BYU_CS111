...
def main():
    #all the files which need to be opened.
    ...
    # prints to terminal so we can see what is going on. 
    print("Processing " + filename + "...")
    # grab the line with the headers
    input_file.readline()
    

    #takes each line and puts each attribute in a list. element 0 is student name
    for row in input_file:
        
        #clean the data from Admission. strip white space
        ...
        # used to print names to composite_chosen.csv if they score above 6 or others
