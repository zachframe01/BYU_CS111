...
@max_score(0)
@with_import('linked_lists', 'convert_link')
@with_import('Link', 'Link')
...
@max_score(0)
@with_import('linked_lists', 'store_digits')
@with_import('Link', 'Link')
...
@max_score(0)
@with_import('linked_lists', 'every_other')
@with_import('Link', 'Link')
...
@max_score(0)
@with_import('linked_lists', 'deep_map_mut')
@with_import('Link', 'Link')
